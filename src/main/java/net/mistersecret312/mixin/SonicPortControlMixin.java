...
public class SonicPortControlMixin {
    ...
    public boolean onRightClicked(ConsoleTile console, PlayerEntity player) {
        if(!console.getWorld().isRemote()) {
            if(ItemTagsInit.SONIC.contains(player.getHeldItemMainhand().getItem()) && console.getSonicItem().isEmpty() && !MinecraftForge.EVENT_BUS.post(new ControlEvent.SonicPutEvent(((SonicPortControl) (Object) this), player, player.getHeldItemMainhand()))) {
            ...
            else if(player.getHeldItemMainhand().isEmpty() && !console.getSonicItem().isEmpty() && !MinecraftForge.EVENT_BUS.post(new ControlEvent.SonicTakeEvent(((SonicPortControl) (Object) this), player, console.getSonicItem()))) {
